...
function renderMap(ipAnalyses) {
    ...
    // Simplified continent outlines (equirectangular projection, viewBox 0 0 720 360)
    var continentPaths = [
        // North America
        "M45,50 L55,42 75,38 95,35 120,32 145,35 160,42 170,55 175,70 168,82 155,88 150,100 145,115 130,130 118,140 108,148 95,155 85,162 78,170 72,178 68,172 60,160 58,148 62,135 70,120 72,108 65,98 58,88 50,78 45,68 Z",
        // South America
        "M135,175 L148,168 160,170 168,178 172,190 175,205 178,220 180,240 178,258 172,272 165,282 155,288 145,285 138,275 132,260 128,242 125,225 122,210 120,195 125,182 Z",
        // Europe
        "M330,42 L340,38 355,35 370,38 385,42 395,48 400,58 398,68 390,75 378,78 365,80 352,78 342,72 335,62 332,52 Z",
        // Africa
        "M330,100 L345,95 362,98 378,102 390,110 398,122 402,138 400,158 395,178 388,198 378,215 365,228 352,235 340,232 330,222 322,208 318,192 315,175 312,158 310,140 315,122 322,110 Z",
        // Asia
        "M400,30 L420,25 445,22 470,25 500,28 530,32 555,28 575,25 600,30 620,38 635,48 645,60 650,75 648,90 640,102 625,110 610,115 590,118 570,120 550,122 530,120 510,115 495,108 480,100 465,92 450,85 438,78 425,70 415,60 408,48 Z",
        // Southeast Asia / Indonesia
        "M545,135 L560,130 578,132 595,138 608,148 615,160 610,168 598,172 582,170 568,165 555,158 548,148 Z",
        // Australia
        "M575,210 L595,202 615,205 630,212 638,225 635,240 625,250 610,255 595,252 582,245 575,235 572,222 Z",
    ];
